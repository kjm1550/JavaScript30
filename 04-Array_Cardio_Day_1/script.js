...
const firstLastArry = inventors.map(inventor => inventor.first + ' ' + inventor.last);
console.log(firstLastArry);
...
const inventorsYearsLived = inventors.sort((a, b) => (a.passed - a.year < b.passed - b.year ? 1 : -1));
...
const peopleAlphabetically = people.sort();
console.log(peopleAlphabetically);

// 8. Reduce Exercise
// Sum up the instances of each of these
const data = ['car', 'car', 'truck', 'truck', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car', 'van', 'car', 'truck'];
const sumOfData = data.reduce(function(obj, item) {
